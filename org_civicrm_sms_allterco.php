 ...
 *
 */
class org_civicrm_sms_allterco extends CRM_SMS_Provider {
...
const MAX_SMS_CHAR = 160;
  ...
  static function &singleton($providerParams = array(
    ...
    if (!isset(self::$_singleton[$cacheKey]) || $force) {
      ...
      self::$_singleton[$cacheKey] = new org_civicrm_sms_allterco($provider, $skipAuth);
    }
...
die();
  ...
  /**
   * Inbound is used for hadling messages replies
